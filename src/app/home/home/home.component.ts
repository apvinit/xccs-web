  ...
  public prominentPersons: Person[] = [
    {
      ...
      imageUrl: 'http://0516p.info/imp%20img/rec.jpg'
    },
    {
      name: 'Christu Savarirajan',
      description: 'Principal, St. Xavier\'s School',
      imageUrl: 'http://0516p.info/imp%20img/pr.jpg'
    },
    {
      name: 'Dr. Abhilash Nayak',
      description: 'Regional Director, IGNOU',
      imageUrl: 'http://0516p.info/imp%20img/rdPatna.jpg'
    },
    {
      name: 'Md. Shams Raza',
      description: 'Programme Incharge 0516P',
      imageUrl: 'http://0516p.info/imp%20img/sir.jpg'
    }
  ];
  ngOnInit() {}
}
